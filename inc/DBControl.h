#ifndef _DBCONTROL_H_
#define _DBCONTROL_H_
...
/**
 * [DBControl] application must inherit from Application class
...
public:
	...
	/**
	 * [DBControl] application must have a factory method that creates an instance of itself.
	 */
